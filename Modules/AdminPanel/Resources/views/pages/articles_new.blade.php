...
@section('content')
  ...
  <div class="container-fluid">            
    ...
    <form id="articles_new_form" action="/admin/artikelen/toevoegen-post" method="POST">
          ...
          <div class="col-lg-auto text-center">
            ...
            <div class="tab-content tab-articles bg-white rounded">
              ...
              <div class="tab-pane active ml-5 mr-5" id="tab-1">
                <h1>Categorieën</h1>
                <hr class="pt-0">
                <div class="form-group" name="categorys">
                  <div class="form-check">
                    <input class="form-check-input " type="checkbox" value=4 name="categorys[]" style="transform: scale(1.5);" checked>
                    <label class="form-check-label ml-4" for="category_general">
                      Algemeen
                    </label>
                  </div>
                  <div class="form-check pt-2">
                    <input class="form-check-input" type="checkbox" value=1 name="categorys[]" style="transform: scale(1.5);">
                    <label class="form-check-label ml-4" for="category_hardware">
                      Hardware
                    </label>
                  </div>
                  <div class="form-check pt-2">
                    <input class="form-check-input" type="checkbox" value=2 name="categorys[]" style="transform: scale(1.5);">
                    <label class="form-check-label ml-4" for="category_software">
                      Software
                    </label>
                  </div>
                  <div class="form-check pt-2">
                    <input class="form-check-input" type="checkbox" value=3 name="categorys[]" style="transform: scale(1.5);">
